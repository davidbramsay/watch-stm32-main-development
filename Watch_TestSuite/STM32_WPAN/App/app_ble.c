...
//P2P FIX #include "dis_app.h"
//P2P FIX #include "hrs_app.h"
...
static const char local_name[] = { AD_TYPE_COMPLETE_LOCAL_NAME ,'D','B','R','T','E','S','T'};
...
//P2P FIX static void Add_Advertisment_Service_UUID( uint16_t servUUID );
  ...
  switch (event_pckt->evt)
  {
    ...
    case EVT_VENDOR:
      ...
      case EVT_BLUE_GAP_PASS_KEY_REQUEST:  
        ...
        //P2P FIX aci_gap_pass_key_resp(BleApplicationContext.BleApplicationContext_legacy.connectionHandle,123456);
