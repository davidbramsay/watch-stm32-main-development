...
#define IQS_TOUCH_THRESH 4 //touch sensitivity threshold (10/20), larger is more
...
static const int MAP_ANGLE_MEASURED[] = {0, 40, 115, 135, 180, 225, 250, 320, 360};
//static const int MAP_ANGLE_MEASURED[] = {0, 52, 108, 159, 210, 231, 252, 306, 360};
