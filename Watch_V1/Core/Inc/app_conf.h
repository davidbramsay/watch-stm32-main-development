 ...
 * Define Tx Power
 */
#define CFG_TX_POWER                      (0x1C)//(0x18) /* -0.15dBm */
...
#define CFG_P2P_PROCESS_NAME                  "P2P_PROCESS"
#define CFG_P2P_PROCESS_ATTR_BITS             (0)
#define CFG_P2P_PROCESS_CB_MEM                (0)
#define CFG_P2P_PROCESS_CB_SIZE               (0)
#define CFG_P2P_PROCESS_STACK_MEM             (0)
#define CFG_P2P_PROCESS_PRIORITY              osPriorityNone
