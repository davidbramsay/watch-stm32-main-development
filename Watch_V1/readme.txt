...
- BLE background testing.  Send data contantly, leave on and test.  If not
  ...
  @page Watch_V1 example
  
  @verbatim
  ******************************************************************************
  * @file    BLE/Watch_V1/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of the Watch_V1 example.
  ******************************************************************************
  *
...
@par Directory contents 
  ...
  - BLE/Watch_V1/Core/Inc/stm32wbxx_hal_conf.h		HAL configuration file
  - BLE/Watch_V1/Core/Inc/stm32wbxx_it.h          	Interrupt handlers header file
  - BLE/Watch_V1/Core/Inc/main.h                  	Header for main.c module
  - BLE/Watch_V1/STM32_WPAN/App/app_ble.h          Header for app_ble.c module
  - BLE/Watch_V1/Core/Inc/app_common.h            	Header for all modules with common definition
  - BLE/Watch_V1/Core/Inc/app_conf.h              	Parameters configuration file of the application
  - BLE/Watch_V1/Core/Inc/app_entry.h            	Parameters configuration file of the application
  - BLE/Watch_V1/STM32_WPAN/App/ble_conf.h         BLE Services configuration
  - BLE/Watch_V1/STM32_WPAN/App/ble_dbg_conf.h     BLE Traces configuration of the BLE services
  - BLE/Watch_V1/STM32_WPAN/App/dis_app.h          Header for dis_app.c module
  - BLE/Watch_V1/STM32_WPAN/App/hrs_app.h          Header for hrs_app.c module
  - BLE/Watch_V1/Core/Inc/hw_conf.h           		Configuration file of the HW
  - BLE/Watch_V1/Core/Inc/utilities_conf.h    		Configuration file of the utilities
  - BLE/Watch_V1/STM32_WPAN/App/FreeRTOSConfig.h   Configuration file of FreeRTOS
  - BLE/Watch_V1/Core/Src/stm32wbxx_it.c          	Interrupt handlers
  - BLE/Watch_V1/Core/Src/main.c                  	Main program
  - BLE/Watch_V1/Core/Src/system_stm32wbxx.c      	stm32wbxx system source file
  - BLE/Watch_V1/STM32_WPAN/App/app_ble.c      	BLE Profile implementation
  - BLE/Watch_V1/Core/Src/app_entry.c      		Initialization of the application
  - BLE/Watch_V1/STM32_WPAN/App/dis_app.c      	Device Information Service application
  - BLE/Watch_V1/STM32_WPAN/App/hrs_app.c      	Heart Rate Service application
  - BLE/Watch_V1/STM32_WPAN/Target/hw_ipcc.c      	IPCC Driver
  - BLE/Watch_V1/Core/Src/stm32_lpm_if.c			Low Power Manager Interface
  - BLE/Watch_V1/Core/Src/hw_timerserver.c 		Timer Server based on RTC
  - BLE/Watch_V1/Core/Src/hw_uart.c 				UART Driver
...
In order to make the program work, you must do the following:
 ...
 - Power on the Nucleo board with the Watch_V1 application
